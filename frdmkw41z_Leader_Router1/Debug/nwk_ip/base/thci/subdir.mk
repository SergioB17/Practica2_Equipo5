...
nwk_ip/base/thci/%.o: ../nwk_ip/base/thci/%.c nwk_ip/base/thci/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-nwk_ip-2f-base-2f-thci

clean-nwk_ip-2f-base-2f-thci:
	-$(RM) ./nwk_ip/base/thci/thci.d ./nwk_ip/base/thci/thci.o

.PHONY: clean-nwk_ip-2f-base-2f-thci
